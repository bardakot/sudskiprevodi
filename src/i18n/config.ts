      ...
      locations: {
        ...
        cities: {
          ...
          prilep: {
            ...
            description: 'Испратете ги документите онлајн и добијте го готовиот заверен превод на вашата адреса во Прилеп.',
          },
          bitola: {
            title: 'Судски преводи за Битола',
            description: 'Испратете ги документите онлајн и добијте го готовиот заверен превод на вашата адреса во Битола.',
          },
        },
      },
      contact: {
    ...
    translation: {
      ...
      locations: {
        ...
        cities: {
          ...
          prilep: {
            title: 'Судски преводи за Прилеп',
            description: 'Пошаљите документе онлајн и примите готов оверени превод на својој адреси у Прилепу.',
          },
          bitola: {
            title: 'Судски преводи за Битољ',
            description: 'Пошаљите документе онлајн и примите готов оверени превод на својој адреси у Битољу.',
          },
        },
      },
      contact: {
